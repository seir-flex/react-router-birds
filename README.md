...
1. Create a new react app called `react-audubon-site-lab`.
...
Here is a [working solution](https://wphtl.csb.app/) of the app
...
```js
// Destructure the array that is returned from useState into a variable to hold the data 
...
Now, you can add your fetch request inside the curly braces of the callback function. The url for our birds API is: https://ga-audubon-api.herokuapp.com/api/birds. Use the async/await syntax for your fetch call:
